...
class Window:
    ...
    def __init__(self,y): 
        ...
        self.rect1=pygame.Rect(self.gap,y+250 ,40,20)
        self.rect2=pygame.Rect(self.gap,y+140,50,5)
        self.rect3=pygame.Rect(self.gap,y+100,50,10)
    def display(self):  
    ...
    def move(self):
        ...
        if(self.rect1.y>600):
            self.rect1.y =-200
            self.rect2.y=-30
            self.rect1.x=random.randint(200, 500)
